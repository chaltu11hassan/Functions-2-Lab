...
//price = 15 tax = 0.09
//totalAfterTax = 15.09 use .forEach to get the total of each index by lopping through
...
const orderTotals = orders.map(obj => obj.price + (obj.price * obj.tax))
